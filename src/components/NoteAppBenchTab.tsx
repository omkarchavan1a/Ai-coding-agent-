      ...
      <div className="bg-[#21222D] border border-[#2A2C3A] rounded-2xl p-5 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4 text-white">
        <div>
          ...
          <p className="text-xs text-slate-300 mt-1">
            Test the updated <code className="text-[#ACD1FD] font-mono bg-[#191A23] px-2 py-0.5 rounded-full">node-easy-notes-app</code> backend endpoints modified by our AI Agent.
          </p>
        </div>
